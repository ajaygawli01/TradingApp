  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.userType === 'company') {
        // endpoint = 'https://ticket-backend-gy6j.onrender.com/api/company/register'; // Replace 'YOUR_COMPANY_API_ENDPOINT' with the endpoint for company registration
      } else {
        // endpoint = 'https://ticket-backend-gy6j.onrender.com/api/register'; // Replace 'YOUR_USER_API_ENDPOINT' with the endpoint for user registration
      }
