...
const Login = () => {
  ...
  //       };
  //       endpoint = 'https://ticket-backend-gy6j.onrender.com/api/company/login'; // Replace with the actual company login endpoint
  //     } else {
  //       loginData = {
  //         email: formData.email,
  //         password: formData.password
  //       };
  //       endpoint = 'https://ticket-backend-gy6j.onrender.com/api/login'; // Replace with the actual user login endpoint
  //     }
